...
export default function NomineeStatusPage() {
  ...
  const handleBack = () => {
    router.push(`/nominee-onboarding?token=${token}`)
  }
    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="w-full md:w-3/5 p-8 flex items-center justify-center">
        <div className="max-w-lg w-full">
          ...
          <h2 className="text-2xl font-bold mb-6">Nomination Status</h2>

          <p className="text-gray-700 mb-6">
            You have been designated as a nominee by the user, reflecting your close familial relationship or kinship.
            This access may have been granted directly by the user, their Trustee, or the App Owner, depending on the
            user's preferences or health condition.
          </p>

          <h2 className="text-2xl font-bold mb-6">Access Authorization</h2>

          <p className="text-gray-700 mb-8">
            You are authorized to access the user's critical information. Your level of access may be partial or
            complete, depending on the user's decision.
          </p>
