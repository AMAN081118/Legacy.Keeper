...
export interface ApiFaqCategoryQuestionFaqCategoryQuestion
  extends Struct.CollectionTypeSchema {
  collectionName: 'faq_category_questions';
  info: {
    displayName: 'FAQ Category Question';
    pluralName: 'faq-category-questions';
    singularName: 'faq-category-question';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::faq-category-question.faq-category-question'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFaqCategoryFaqCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faq_category_questions: Schema.Attribute.Relation<
      'oneToMany',
      'api::faq-category-question.faq-category-question'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::faq-category-question.faq-category-question': ApiFaqCategoryQuestionFaqCategoryQuestion;
